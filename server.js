...
mongo.MongoClient.connect(process.env.MONGOLAB_URI || 'mongodb://localhost:27017/url-shorten', function(err, db) {
    ...
    app.get('/', function(req, res) {
        res.send('Put <h1>/new/youUrl</h1> after url to get shortenUrl<br><hr> And then put <h1>/short_url</h1> after url to redirect original website' + JSON.stringify(process.env));
    })
